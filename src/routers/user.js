...
router.patch('/users/me', auth, async (req,res)=>{
  ...
  try{
    ...
    updates.forEach((update)=>{
     ...
     await req.user.save() // to run middleware
    // const user = await User.findByIdAndUpdate(req.params.id, req.body, {new: true, context: 'query'})  // new will get the modified data rather than previos data
    res.send(req.user)
